  ...
  return (
    <section>
      <div className="flex flex-row justify-between mt-32">
        <div className="border-t-2 border-gold pt-4 pr-4 max-w-xl">
      ...
      <div className="mt-12">
        ...
        >
          <li>
            <span className="absolute mt-6 font-bold tracking-wider">
              Typescript
            </span>
          </li>
          <li>
          ...
          <li>
            <span className="absolute mt-6 font-bold tracking-wider">C#</span>
          </li>
          <li>
            <span className="absolute mt-6 font-bold tracking-wider">
              Twilio
